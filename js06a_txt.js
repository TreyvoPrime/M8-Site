...
window.addEventListener("load", function() {
      ...
      for (let i = 0; i < orderForm.elements.lengthl; i++) {
...
function calcOrder() {
      ...
      orderForm.elements.modelNane.value = model.options[mIndex].text;
      let selectedPlan = document.querySelector('input[name="plan"]:checked')
      orderForm.elements.plaName.value = selectedPlan.labels[0].textContent;
}
